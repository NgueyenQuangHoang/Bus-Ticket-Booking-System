    ...
    return (
        <div className="">
            <button
                ...
                className="rounded-md bg-[#1190D4] px-4 py-2 text-[10px] font-semibold text-white shadow-sm hover:bg-blue-500 transition-colors"
            >
                Đăng nhập
            </button>
            {open && (
                                ...
                                <>
                                    <div className="flex gap-2">
                                        <div className="flex flex-col w-1/2">
                                            <input
                                                ...
                                                className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.first_name ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]'}`}
                                            />
                                        ...
                                        <div className="flex flex-col w-1/2">
                                            <input
                                                ...
                                                className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.last_name ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]'}`}
                                            />
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.phone ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]'}`}
                                        />
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]'}`}
                                        />
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.password ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]'}`}
                                        />
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.confirmPassword ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]'}`}
                                        />
