        ...
        <header className="w-full font-['Segoe_UI']">
            ...
            <div className="bg-white shadow-sm relative z-20 h-[60px] flex items-center px-[170px] gap-[90px]">
                ...
                <div className="w-[100px] h-[60px] flex items-center justify-center">
                    <img src={logoMain} alt="Vivu Today" className="h-full w-full object-contain" />
                </div>

                {/* Desktop Navigation */}
                <nav className="hidden lg:flex items-center gap-[8px] flex-1">
                    <a href="/" className="bg-[#1190D4] text-white h-[41px] px-[10.5px] rounded-[7px] flex items-center justify-center font-bold text-[14px] uppercase tracking-[0.28px]">
                        Trang chủ
                    </a>
                    <a href="#" className="h-[41px] px-[8px] flex items-center font-bold text-[14px] text-[#1190D4] uppercase tracking-[0.28px] hover:text-blue-800 transition-colors">
                        Giới thiệu
                    </a>
                    <a href="#" className="h-[41px] px-[8px] flex items-center font-bold text-[14px] text-[#1190D4] uppercase tracking-[0.28px] hover:text-blue-800 transition-colors">
                        Thông tin nhà xe
                ...
                <div className="fixed inset-0 z-50 lg:hidden">
                    ...
                    <aside className="absolute left-0 top-0 h-full w-[280px] bg-white shadow-2xl flex flex-col animate-slide-in-left">
                        <div className="p-4 border-b flex items-center justify-between bg-[#1295db]">
                             <img src={logoMain} alt="logo" className="h-8 object-contain brightness-0 invert" />
                            <button
                                onClick={() => setDrawerOpen(false)}
                        ...
                        <div className="flex-1 overflow-y-auto py-4">
                            <nav className="flex flex-col text-[#1295db] font-semibold text-base uppercase">
                                <a href="#" className="py-3 px-6 hover:bg-sky-50 border-l-4 border-transparent hover:border-[#1295db] transition-all">Trang chủ</a>
                                <a href="#" className="py-3 px-6 hover:bg-sky-50 border-l-4 border-transparent hover:border-[#1295db] transition-all">Giới thiệu</a>
                                <a href="#" className="py-3 px-6 hover:bg-sky-50 border-l-4 border-transparent hover:border-[#1295db] transition-all">Thông tin nhà xe</a>
                                <a href="#" className="py-3 px-6 hover:bg-sky-50 border-l-4 border-transparent hover:border-[#1295db] transition-all">Bến xe</a>
                                <a href="#" className="py-3 px-6 hover:bg-sky-50 border-l-4 border-transparent hover:border-[#1295db] transition-all">Tuyến đường</a>
                                <a href="#" className="py-3 px-6 hover:bg-sky-50 border-l-4 border-transparent hover:border-[#1295db] transition-all">Kiểm tra vé</a>
                                <a href="#" className="py-3 px-6 hover:bg-sky-50 border-l-4 border-transparent hover:border-[#1295db] transition-all">Travel</a>
                            </nav>
                        </div>
                    </aside>
                </div>
