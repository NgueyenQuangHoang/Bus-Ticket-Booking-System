...
export default function AreaCodeSelect({ value, onChange } : AreaCodeSelectProps)  {
  ...
  return (
    <div
      ref={containerRef}
      className={`relative w-32 h-[42px] border rounded-lg bg-white flex items-center justify-between px-3 cursor-pointer transition-colors select-none
        ${
          isOpen
    ...
    >
      ...
      {/* Dropdown List */}
      {isOpen && (
        <div className="absolute top-[110%] left-0 w-[240px] max-h-[250px] overflow-y-auto bg-white border border-gray-200 rounded-lg shadow-xl z-50 animate-in fade-in zoom-in duration-200 custom-scrollbar">
