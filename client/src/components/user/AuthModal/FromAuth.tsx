    ...
    <div className="">
      ...
      {shouldRender && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
          ...
          <div
            className={`relative z-10 w-full max-w-md overflow-hidden rounded-lg bg-white shadow-xl flex flex-col max-h-[90vh] transition-all duration-300 ease-in-out transform ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"
              }`}
          >
                ...
                <>
                  <div className="flex gap-2">
                    <div className="flex flex-col w-1/2">
                      <input
                        ...
                        className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.first_name
                    ...
                    <div className="flex flex-col w-1/2">
                      <input
                        ...
                        className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.last_name
                            ? "border-red-500 focus:ring-red-500"
                            : "border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]"
                          }`}
                      />
                  ...
                  <div>
                    <input
                      ...
                      className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.phone
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]"
                        }`}
                    />
                  ...
                  <div>
                    <input
                      ...
                      className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.email
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]"
                        }`}
                    />
                  ...
                  <div>
                    <input
                      ...
                      className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.password
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]"
                        }`}
                    />
                  ...
                  <div>
                    <input
                      ...
                      className={`w-full border rounded-md p-2.5 focus:outline-none focus:ring-1 ${errors.confirmPassword
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-300 focus:border-[#1190D4] focus:ring-[#1190D4]"
                        }`}
                    />
